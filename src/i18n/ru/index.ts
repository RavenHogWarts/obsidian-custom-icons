	...
	settings: {
		...
		tabHeader: {
			...
			mapping: {
				...
				desc: "Назначьте запасные значки типам представлений (data-type); они применяются ко всем вкладкам типа без индивидуальной настройки. Настроенные записи перечислены здесь.",
