	...
	settings: {
		...
		tabHeader: {
			...
			mapping: {
				...
				desc: "Назначьте запасные значки типам представлений (data-type); они применяются ко всем вкладкам типа без индивидуальной настройки; также можно задать значок на месте, щёлкнув правой кнопкой по значку вкладки. Настроенные записи перечислены здесь.",
